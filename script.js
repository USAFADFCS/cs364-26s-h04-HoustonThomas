...
function getIngredients() {
  ...
  return new Promise((resolve, reject) => {
    ...
    wait(2000).then(()=>{
      ...
      reject("Failed to get ingredients ready");
    }
  });
});
}
...
function pourSmoothie() {
  ...
  return new Promise((resolve, reject) => {
    ...
    wait(1000).then(()=>{
      ...
      reject("Failed to get smoothie ready");
    }
  });
});
}
...
function makeSmoothieWithPromises() {
  ...
  //   .then(...)
  //   .catch(...)
  getIngredients().then(blendSmoothie).then(pourSmoothie).catch(e);
}
...
async function makeSmoothieAsync() {
  ...
  try{
    ...
    await blendSmoothie();
    await pourSmoothie();
    showMessage("Success, enjoy dat smoothie!!!")
  }
  // await getIngredients()
  // await blendSmoothie()
  // await pourSmoothie()
